...
typeName       cstring('LabelDemoType')
  ...
  retv = fmOdbc.odbc.setupSpCall('dbo.InsertaTable', parameters)
  retv = fmOdbc.odbc.execSp()
  
  fmOdbc.closeConnection(openedhere)

  Message('There were ' & rows & ' rows inserted in ' & format(clock() - t, @t4) & ' clock tics ' & clock() - t)
